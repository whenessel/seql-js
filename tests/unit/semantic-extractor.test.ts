...
describe('SemanticExtractor', () => {
  ...
  describe('extract', () => {
    ...
    it('should extract text for all text-extractable tags', () => {
      const tags = ['button', 'a', 'label', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'p', 'span', 'li', 'th', 'td', 'dt', 'dd', 'legend', 'figcaption', 'summary'];
  ...
  describe('extractAttributes', () => {
    ...
    it('should skip dynamic values (long hashes)', () => {
      ...
      div.setAttribute('data-id', 'a1b2c3d4e5f6a7b8c9d0e1f2a3b4c5d6e7f8a9b0c1d2e3f4a5b6c7d8e9f0a1b2');
      div.setAttribute('data-testid', 'div');
      document.body.appendChild(div);
